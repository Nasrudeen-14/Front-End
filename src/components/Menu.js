    ...
    return(
        ...
        <section class="section">
                <article class="article1">
                 ...
                 <img src={burchetta} alt="food item"class="image" width="200em" height="150em"/>
                ...
                <article class="article2">
                    ...
                    <img src={salad} alt="salad"class="image" width="200em" height="150em"/>
                ...
                <article class="article3">
                    ...
                    <img src={desert} alt="sweet"class="image" width="200em" height="150em"/>
